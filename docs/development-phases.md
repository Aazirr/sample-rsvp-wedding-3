...
- [x] Copy the wedding invitation sample into the SunSpire workspace
- [x] Remove source Git history and prepare this folder as a standalone project
- [x] Replace sample people names with placeholder names across the site content
